...
local vehshop = {
	...
	menu = {
		...
		["audi"] = {
			...
			name = "audi",
			buttons = {
				{name = "Audi RS5", costs = 90000, description = {}, model = "RS5"},
			    {name = "Audi RS3", costs = 70000, description = {}, model = "rs3"},
			    {name = "Audi SQ7 2016", costs = 22000, description = {}, model = "SQ72016"},			
			    {name = "Audi RS7", costs = 85000, description = {}, model = "rs7"},
			    {name = "Audi A8", costs = 100000, description = {}, model = "a8fsi"},
				{name = "Audi R8", costs = 90000, description = {}, model = "r8ppi"},
				{name = "Audi TT", costs = 70000, description = {}, model = "tts"},
			}
		},
		["bmw"] = {
			title = "bmw",
			name = "bmw",
			buttons = {
			    {name = "BMW M2", costs = 54000, description = {}, model = "m2"},
			    {name = "BMW M3", costs = 90000, description = {}, model = "m3f80"},
			    {name = "BMW M3 E92", costs = 95000, description = {}, model = "m3e92"},
                {name = "BMW E30", costs = 10000, description = {}, model = "m3e30"},			
				{name = "BMW M6", costs = 80000, description = {}, model = "m6f13"},
                {name = "BMW 7", costs = 80000, description = {}, model = "lumma750"},			
			    {name = "BMW I8", costs = 150000, description = {}, model = "i8"},
				{name = "BMW X5", costs = 50000, description = {}, model = "x5m13"},
				{name = "BMW X6", costs = 250000, description = {}, model = "x6m"},
				{name = "BMW M4LB", costs = 50000, description = {}, model = "rmodm4gts"},
		...
		["mercedesbenz"] = {
			...
			buttons = {
				...
				{name = "Mercedes GL63", costs = 100000, description = {}, model = "gl63"},
				{name = "Mercedes G65", costs = 250000, description = {}, model = "g65amg"},
				{name = "Mercedes S400", costs = 75000, description = {}, model = "x222"},
			}
		},
		["Dacia"] = {
			title = "Dacia",
		...
		["ferrari"] = {
			...
			name = "ferrari",
			buttons = {
				{name = "Ferrari LaFerrari", costs = 500000, description = {}, model = "aperta"},
		...
		["Lux"] = {
			...
			buttons = {
			    ...
			    {name = "Bentley Continental", costs = 500000, description = {}, model = "contgt13"},
			    ...
			    {name = "McLaren P1", costs = 300000, description = {}, model = "p1"},
			...
			for i,button in pairs(menu.buttons) do
				if i >= vehshop.menu.from and i <= vehshop.menu.to then
					...
					if button.costs ~= nil then
						if vehshop.currentmenu == "audi" or vehshop.currentmenu == "bmw" or vehshop.currentmenu == "Hitman" or vehshop.currentmenu == "Mafia" or vehshop.currentmenu == "mercedesbenz" or vehshop.currentmenu == "ferrari" or vehshop.currentmenu == "Porsche" or vehshop.currentmenu == "Volkswagen" or vehshop.currentmenu == "Lux" or vehshop.currentmenu == "cars5" or vehshop.currentmenu == "biciclete" or vehshop.currentmenu == "altele" or vehshop.currentmenu == "motociclete" or vehshop.currentmenu == "cop" or vehshop.currentmenu == "fbi" or vehshop.currentmenu == "fisher" or vehshop.currentmenu == "ems" or vehshop.currentmenu == "uber" or vehshop.currentmenu == "lawyer" or vehshop.currentmenu == "delivery" or vehshop.currentmenu == "repair" or vehshop.currentmenu == "bankdriver" or vehshop.currentmenu == "medicalweed" or vehshop.currentmenu == "vip" or vehshop.currentmenu == "avivip" or vehshop.currentmenu == "helivip" or vehshop.currentmenu == "Dacia" then
...
function vehSR_ButtonSelected(button)
	...
	elseif this == "audi" or this == "bmw" or this == "Hitman" or this == "mercedesbenz" or this == "ferrari" or this == "Mafia" or this == "Porsche" or this == "Volkswagen" or this == "Lux" or this == "cars5" or this == "biciclete" or this == "altele" or this == "cop" or this == "fbi" or this == "fisher" or this == "ems" or this == "uber" or this == "lawyer" or this == "delivery" or this == "repair" or this == "bankdriver" or this == "medicalweed" or this == "vip" or this == "avivip" or this == "helivip" or vehshop.currentmenu == "Dacia" then
...
function vehSR_Back()
	...
	if vehshop.currentmenu == "main" then
		vehSR_CloseCreator("","")
	elseif vehshop.currentmenu == "audi" or vehshop.currentmenu == "bmw" or vehshop.currentmenu == "Hitman" or vehshop.currentmenu == "Mafia" or vehshop.currentmenu == "mercedesbenz" or vehshop.currentmenu == "ferrari" or vehshop.currentmenu == "Porsche" or vehshop.currentmenu == "Volkswagen" or vehshop.currentmenu == "Lux" or vehshop.currentmenu == "cars5" or vehshop.currentmenu == "biciclete" or vehshop.currentmenu == "altele" or vehshop.currentmenu == "motociclete" or vehshop.currentmenu == "cop" or vehshop.currentmenu == "fisher" or vehshop.currentmenu == "fbi" or vehshop.currentmenu == "ems" or vehshop.currentmenu == "uber" or vehshop.currentmenu == "lawyer" or vehshop.currentmenu == "delivery" or vehshop.currentmenu == "repair" or vehshop.currentmenu == "bankdriver" or vehshop.currentmenu == "medicalweed" or vehshop.currentmenu == "vip" or vehshop.currentmenu == "aviatie" or vehshop.currentmenu == "Dacia" then
		if DoesEntityExist(fakecar.car) then
			Citizen.InvokeNative(0xEA386986E786A54F, Citizen.PointerValueIntInitialized(fakecar.car))
		end
		fakecar = {model = '', car = nil}
